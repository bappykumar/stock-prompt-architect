...
CRITICAL GENDER & BODY BUILD RULE: If there is a person/human in the image, you MUST explicitly state their GENDER/AGE CATEGORY (e.g., "man", "woman", "boy", "girl", "baby"). For BODY BUILD, ONLY mention it if they are distinctly outside the average/standard norm (e.g., "plus-size", "heavy-set", "muscular", "very tall", "petite"). If they have an average, normal, or standard slim body, DO NOT mention their body type at all (just say "a man" or "a woman").
CAMERA DIRECTION RULE: Describe where the subject is looking or their expression (e.g., "looking forward", "making eye contact", "looking away"), but DO NOT use the word "camera" (e.g., NEVER write "looking at the camera").
FLEXIBLE ATTIRE RULE: Describe attire generically (e.g., "in a business suit", "in casual wear", "wearing a dress") WITHOUT locking in specific colors unless the color is strictly central to the action. This allows the prompt generator to create diverse stock variations.
AVOID specifying race or ethnicity IN THIS FIELD. Focus on gender, notable body build (if any), core action, key props, and expression. No framing, no lighting, no technical terms.
...
Return ONLY this JSON structure, no markdown:
{
  ...
  2. "smartRefinement": A concise core description of the main subject and their specific action/appearance based on the input. Maximum 25 words. If a person/human is described, observe and explicitly state their GENDER/AGE CATEGORY (e.g., "man", "woman", "boy", "girl", "baby"). For BODY BUILD, ONLY mention it if they are distinctly outside the average/standard norm (e.g., "plus-size", "heavy-set", "muscular"). If they have an average, normal, or standard slim body, DO NOT mention their body type at all. If NO person is described, do not mention gender/body build. CAMERA DIRECTION RULE: If the text mentions looking at the camera, rephrase it to "looking forward" or "making eye contact"; DO NOT use the word "camera". FLEXIBLE ATTIRE RULE: Retain the type of attire but AVOID locking in specific colors unless strictly central to the action, to allow for diverse stock variations. AVOID specifying race or ethnicity IN THIS FIELD. Focus on gender/age category, notable body build, core action, and props. No framing, no lighting, no technical terms.
