...
CRITICAL GENDER & BODY BUILD RULE: If there is a person/human in the image, you MUST carefully observe and explicitly state their GENDER/AGE CATEGORY (e.g., "man", "woman", "boy", "girl", "baby", "toddler", "infant") AND their BODY BUILD / PHYSIQUE (e.g., "plus-size", "full-figured", "heavy-set", "curvy", "slim", "slender", "thin", "athletic", "muscular", "tall", "short"). DO NOT omit their gender or body type! For example, write "a plus-size woman", "a slim athletic man", or "a chubby baby".
If there are NO people in the image, do NOT mention any gender, age, or body build.
AVOID specifying race or ethnicity IN THIS FIELD (e.g., use "a plus-size woman" instead of "a plus-size East Asian woman"), because ethnicity is mapped to the 'settings' object separately. Focus on gender/age category, body build, core action, and distinctive props or attire. No framing, no lighting, no technical terms.
...
Return ONLY this JSON structure, no markdown:
{
  ...
  2. "smartRefinement": A concise core description of the main subject and their specific action/appearance based on the input. Maximum 20 words. If a person/human is described, observe and explicitly state their GENDER/AGE CATEGORY (e.g., "man", "woman", "boy", "girl", "baby", "toddler", "infant") AND their BODY BUILD / PHYSIQUE (e.g., plus-size/heavy-set, slim/slender, athletic, tall, short) if indicated. For example, write "a plus-size woman", "a slim athletic man", or "a chubby baby". If NO person is described, do not mention gender/body build. AVOID specifying race or ethnicity IN THIS FIELD (e.g., use "a plus-size woman" instead of "a plus-size East Asian woman"), because ethnicity is mapped to the 'settings' object separately. Focus on gender/age category, body build, core action, and distinctive props or attire. No framing, no lighting, no technical terms.
