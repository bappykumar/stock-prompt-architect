...
CRITICAL GENDER RULE: If there is a person/human in the image, you MUST explicitly state their GENDER (e.g., "man", "woman", "boy", "girl", "baby"). DO NOT specify age categories (like "young adult" or "elderly") in this field, as age is mapped to the 'settings' object separately.
...
CAMERA DIRECTION RULE: Describe where the subject is looking (e.g., "looking forward", "making eye contact", "looking away"), but DO NOT use the word "camera".
FLEXIBLE ATTIRE RULE: Describe attire generically (e.g., "in a polka dot shirt") WITHOUT locking in specific colors unless strictly central to the action.
AVOID specifying race, ethnicity, or age IN THIS FIELD. Focus on gender, notable body build (if any), core action, key props, and expression. No framing, no lighting, no technical terms.
...
Return ONLY this JSON structure, no markdown:
{
  ...
  2. "smartRefinement": A concise core description of the main subject and their specific action/appearance based on the input. Maximum 25 words. If a person/human is described, observe and explicitly state their GENDER (e.g., "man", "woman", "boy", "girl", "baby"). DO NOT specify age categories (like "young adult" or "senior") in this field, as age is mapped to the 'settings' object separately. For BODY BUILD, ONLY mention it if they are distinctly outside the average/standard norm (e.g., "plus-size", "heavy-set", "muscular"). If they have an average/slim body, DO NOT mention their body type at all. CAMERA DIRECTION RULE: If the text mentions looking at the camera, rephrase it to "looking forward" or "making eye contact"; DO NOT use the word "camera". FLEXIBLE ATTIRE RULE: Retain the type of attire but AVOID locking in specific colors unless strictly central to the action. AVOID specifying race, ethnicity, or age IN THIS FIELD. Focus on gender, notable body build, core action, and props. No framing, no lighting, no technical terms.
