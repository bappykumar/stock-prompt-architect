...
CRITICAL GENDER & BODY BUILD RULE: If there is a person/human in the image, you MUST carefully observe and explicitly state their GENDER (e.g., "man", "woman", "boy", "girl") AND their BODY BUILD / PHYSIQUE (e.g., "plus-size", "full-figured", "heavy-set", "curvy", "slim", "slender", "thin", "athletic", "muscular", "tall", "short"). DO NOT omit their gender or body type! For example, write "a plus-size woman" or "a slim athletic man".
AVOID specifying age, race, or ethnicity IN THIS FIELD (e.g., use "a plus-size woman" or "a slim tall man" instead of "a young East Asian woman"), because age and ethnicity are mapped to the 'settings' object separately. Focus on gender, body build/physique/stature, core action, and distinctive props or attire. No framing, no lighting, no technical terms.
...
Return ONLY this JSON structure, no markdown:
{
  ...
  2. "smartRefinement": A concise core description of the main subject and their specific action/appearance based on the input. Maximum 20 words. If a person/human is described, observe and explicitly state their GENDER (e.g., "man", "woman", "boy", "girl") AND their BODY BUILD / PHYSIQUE (e.g., plus-size/heavy-set, slim/slender, athletic, tall, short) if indicated. For example, write "a plus-size woman" or "a slim athletic man". AVOID specifying age, race, or ethnicity IN THIS FIELD (e.g., use "a plus-size woman" instead of "a young East Asian woman"), because age and ethnicity are mapped to the 'settings' object separately. Focus on gender, body build, core action, and distinctive props or attire. No framing, no lighting, no technical terms.
